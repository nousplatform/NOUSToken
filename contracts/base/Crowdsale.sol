...
//        Data.SaleContractType _saleContractType
//    ) {
//        _finalize = salesAgents[_salesAgentAddress].isFinalized;
//        _startTime = salesAgents[_salesAgentAddress].startTime;
//        _endTime = salesAgents[_salesAgentAddress].endTime;
//        _tokensLimit = salesAgents[_salesAgentAddress].tokensLimit;
//        _tokensMinted = salesAgents[_salesAgentAddress].tokensMinted;
//        _rate = salesAgents[_salesAgentAddress].rate;
//        _minDeposit = salesAgents[_salesAgentAddress].minDeposit;
//        _saleContractType = salesAgents[_salesAgentAddress].saleContractType;
//
//        return (_finalize, _startTime, _endTime, _tokensLimit, _tokensMinted, _rate, _minDeposit, _saleContractType);
//    }
//
//    /**** Getters ****/
